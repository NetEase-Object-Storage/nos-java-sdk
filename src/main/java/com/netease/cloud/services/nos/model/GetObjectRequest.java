...
public class GetObjectRequest extends WebServiceRequest {
	...
	/**
	 * Optional memeber indicating the byte length of range，value must be bigger than zero,but if bigger than content-length,
	 * then rangeLength will be set as content-length
	 * default 10MB
	 */
	private long rangeLength = 10 * 1024 * 1024;
	 ...
	 *            stored.
	 * @param versionId
	 *            The version ID specifying a specific version of the object to
	 *            download.
	 * 
	 * @see GetObjectRequest#GetObjectRequest(String, String)
	 */
	 ...
	 *            to download.
	 * 
	 * @return The updated request object, enabling additional method calls to
	 *         be chained together.
	 * 
	 * @see GetObjectRequest#getVersionId()
	 * @see GetObjectRequest#setVersionId(String)
	...
	/**
	 * Returns the optional rangeLength for indicating range download length
	 *
	 * @return the optional rangeLength for indicating range download length
	 */
	...
	/**
	 * Set the optional rangelength for indicating range download length
	 * @param rangeLength range length
	 */
	public void setRangeLength(long rangeLength) throws Exception {
		if(rangeLength <= 0){
			throw new Exception("rangeLength must be bigger than zero");
		}
