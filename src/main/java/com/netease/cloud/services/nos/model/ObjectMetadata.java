...
public class ObjectMetadata implements ObjectExpirationResult {
	...
	/**
	 * Gets the version ID of the associated Nos object if available. Version
	 * IDs are only assigned to objects when an object is uploaded to an Nos
	 * bucket that has object versioning enabled.
	 * 
	 * @return The version ID of the associated Nos object if available.
	 */
	public String getVersionId() {
		return (String) metadata.get(Headers.NOS_VERSION_ID);
	}
