...
public class LengthCheckInputStream extends SdkFilterInputStream {
     ...
     *        to NOS, but set to true for receiving data from NOS.
     */
     ...
     * {@inheritDoc}
     * 
     * @throws ClientException if the data length read has exceeded the expected total, or if
    ...
    private void checkLength(boolean eof) {
        if (eof) {
            ...
            throw new ClientException("More data read than expected: " + diagnosticInfo());
        }
    }
     ...
     * {@inheritDoc}
     * 
     * @throws ClientException if {@link #includeSkipped} is true and the data length skipped
