...
/**
 * Denotes the different cryptographic modes available for securing an NOS object via client-side
 * encryption. Crypto mode can be configured via {@link CryptoConfiguration} when the NOS encryption
...
public enum CryptoMode {
     ...
     * throw security exception if an NOS object retrieved is found to be not protected using
