...
//	public static String region = "JD";
...
//		Constants.NOS_HOST_NAME = "114.113.199.19";
		Constants.NOS_HOST_NAME = "nos-eastchina1.126.net";		//公有云
//		Constants.NOS_HOST_NAME = "nos-jd.163yun.com";		//私有云
//		Constants.NOS_HOST_NAME = "classb-nos0.server.163.org:2088";		//classb私有云
		//开发环境
