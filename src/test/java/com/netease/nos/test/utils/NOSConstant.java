...
public class NOSConstant {
	...
	// NOS域名
	public static final String NOS_HOSTNAME = "http://nos-eastchina1.126.net";
	public static final String NOS_DOMAIN_NAME = ".nos-eastchina1.126.net";
	public static final String NOS_ABSOLUTE_NAME = "nos-eastchina1.126.net.";
