...
public class TestBucketPermission {
	...
	public void testPermission() {
		...
		CreateBucketRequest createBucketRequest11 = new CreateBucketRequest(privatebucketownedby1, TestHostConfig.region, false);
		...
		CreateBucketRequest createBucketRequest12 = new CreateBucketRequest(publicbucketownedby1, TestHostConfig.region, false);
		...
		CreateBucketRequest createBucketRequest21 = new CreateBucketRequest(privatebucketownedby2, TestHostConfig.region, false);
		...
		if (!client2.doesObjectExist("privatebucketownedby2", "zbkey", null)) {
			client2.putObject(privatebucketownedby2, "zbkey", new File("TestFile/123.txt"));
		}

		// owner2's public-read bucket
		CreateBucketRequest createBucketRequest22 = new CreateBucketRequest(publicbucketownedby2, TestHostConfig.region, false);
		...
		if (!client2.doesObjectExist(publicbucketownedby2, "zbkey", null)) {
