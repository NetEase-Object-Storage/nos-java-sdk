...
public class ObejctGetAndDeleteTest {
	...
	public void before(){
		...
		CreateBucketRequest createBucketRequest2 = new CreateBucketRequest(OTHERS_BUCKET, TestHostConfig.region, false);
	...
	public void after(){
		...
		//Clear.clearAllVersions(client2, OTHERS_BUCKET);
	}
