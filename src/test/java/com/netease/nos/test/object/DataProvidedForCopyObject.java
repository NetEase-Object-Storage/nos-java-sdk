...
public class DataProvidedForCopyObject {
	...
	public static Object[][] putSourceBucket() {
		return new Object[][] { { new CreateBucketRequest(sourcebucketfortestcopyobject, TestHostConfig.region, false) } };
	}
	...
	public static Object[][] putDescBucket() {
		return new Object[][] { { new CreateBucketRequest(descbucketfortestcopyobject, TestHostConfig.region, false) } };
	}
